...
std::enable_if_t<sizeof(&Msg::time_stamp) != 0, int64_t> get_msg_recv_timestamp(
        const Msg& msg) {
...
// For ROS2 jazzy and later
template <typename Msg>
std::enable_if_t<sizeof(&Msg::recv_timestamp) != 0, int64_t>
get_msg_recv_timestamp(const Msg& msg) {

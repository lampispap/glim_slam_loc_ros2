![GLIM With Localization](docs/assets/logo2.png "GLIM Logo")
## **Change log **
This version of GLIM is based on v1.0.4, so it's depend on gtsam_points v1.0.4 (https://github.com/se7oluti0n/gtsam_points) branch `localization`
...
- Check README.md in [glim_localization_ros2](https://github.com/se7oluti0n/glim_localization_ros2) in my repositories for how to use launch file

...
struct is_constructible_array_type_impl<
        ...
        enable_if_t<
                ...
                is_iterator_traits<iterator_traits<
                        detected_t<iterator_t, ConstructibleArrayType>>>::
                        value &&
...
using has_erase_with_key_type =
        typename std::conditional<is_detected<detect_erase_with_key_type,

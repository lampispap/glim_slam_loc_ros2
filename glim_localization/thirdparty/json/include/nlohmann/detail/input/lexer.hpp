  ...
  token_type scan_string() {
    ...
    while (true) {
      ...
      switch (get()) {
        ...
        case 0x00: {
          error_message =
                  "invalid string: control character U+0000 (NUL) must be "
                  "escaped to \\u0000";
          return token_type::parse_error;
        }
        ...
        case 0x01: {
          error_message =
                  "invalid string: control character U+0001 (SOH) must be "
                  "escaped to \\u0001";
          return token_type::parse_error;
        }
        ...
        case 0x02: {
          error_message =
                  "invalid string: control character U+0002 (STX) must be "
                  "escaped to \\u0002";
          return token_type::parse_error;
        }
        ...
        case 0x03: {
          error_message =
                  "invalid string: control character U+0003 (ETX) must be "
                  "escaped to \\u0003";
          return token_type::parse_error;
        }
        ...
        case 0x04: {
          error_message =
                  "invalid string: control character U+0004 (EOT) must be "
                  "escaped to \\u0004";
          return token_type::parse_error;
        }
        ...
        case 0x05: {
          error_message =
                  "invalid string: control character U+0005 (ENQ) must be "
                  "escaped to \\u0005";
          return token_type::parse_error;
        }
        ...
        case 0x06: {
          error_message =
                  "invalid string: control character U+0006 (ACK) must be "
                  "escaped to \\u0006";
          return token_type::parse_error;
        }
        ...
        case 0x07: {
          error_message =
                  "invalid string: control character U+0007 (BEL) must be "
                  "escaped to \\u0007";
          return token_type::parse_error;
        }
        ...
        case 0x10: {
          error_message =
                  "invalid string: control character U+0010 (DLE) must be "
                  "escaped to \\u0010";
          return token_type::parse_error;
        }
        ...
        case 0x11: {
          error_message =
                  "invalid string: control character U+0011 (DC1) must be "
                  "escaped to \\u0011";
          return token_type::parse_error;
        }
        ...
        case 0x12: {
          error_message =
                  "invalid string: control character U+0012 (DC2) must be "
                  "escaped to \\u0012";
          return token_type::parse_error;
        }
        ...
        case 0x13: {
          error_message =
                  "invalid string: control character U+0013 (DC3) must be "
                  "escaped to \\u0013";
          return token_type::parse_error;
        }
        ...
        case 0x14: {
          error_message =
                  "invalid string: control character U+0014 (DC4) must be "
                  "escaped to \\u0014";
          return token_type::parse_error;
        }
        ...
        case 0x15: {
          error_message =
                  "invalid string: control character U+0015 (NAK) must be "
                  "escaped to \\u0015";
          return token_type::parse_error;
        }
        ...
        case 0x16: {
          error_message =
                  "invalid string: control character U+0016 (SYN) must be "
                  "escaped to \\u0016";
          return token_type::parse_error;
        }
        ...
        case 0x17: {
          error_message =
                  "invalid string: control character U+0017 (ETB) must be "
                  "escaped to \\u0017";
          return token_type::parse_error;
        }
        ...
        case 0x18: {
          error_message =
                  "invalid string: control character U+0018 (CAN) must be "
                  "escaped to \\u0018";
          return token_type::parse_error;
        }
        ...
        case 0x1A: {
          error_message =
                  "invalid string: control character U+001A (SUB) must be "
                  "escaped to \\u001A";
          return token_type::parse_error;
        }
        ...
        case 0x1B: {
          error_message =
                  "invalid string: control character U+001B (ESC) must be "
                  "escaped to \\u001B";
          return token_type::parse_error;
        }

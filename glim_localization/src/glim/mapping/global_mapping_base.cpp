...
GlobalMappingBase::GlobalMappingBase()
...
void GlobalMappingBase::insert_imu(const double stamp,
...
std::shared_ptr<GlobalMappingBase> GlobalMappingBase::load_module(
        const std::string& so_name) {
  return load_module_from_so<GlobalMappingBase>(so_name,
                                                "create_global_mapping_module");
}
}  // namespace glim
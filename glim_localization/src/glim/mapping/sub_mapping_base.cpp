...
void SubMappingBase::insert_imu(const double stamp,
...
std::shared_ptr<SubMappingBase> SubMappingBase::load_module(
        const std::string& so_name) {
  return load_module_from_so<SubMappingBase>(so_name,
                                             "create_sub_mapping_module");
}
}  // namespace glim
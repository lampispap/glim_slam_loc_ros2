...
CallbackSlot<void(double, double, double, double)> SubMappingCallbacks::on_gps_update;
...
CallbackSlot<void(double, double, double)> GlobalMappingCallbacks::on_gps_update;
...
CallbackSlot<void(const std::map<int, SubMap::Ptr>& submaps)> LocalizationCallbacks::on_update_active_submaps;

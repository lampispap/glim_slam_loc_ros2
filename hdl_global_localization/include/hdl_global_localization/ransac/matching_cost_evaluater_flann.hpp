...
class MatchingCostEvaluaterFlann : public MatchingCostEvaluater {
  ...
  virtual void set_target(pcl::PointCloud<pcl::PointXYZ>::ConstPtr cloud,
                          double max_correspondence_distance) override {
  ...
  virtual double calc_matching_error(
    ...
    return num_inliers ? matching_error / num_inliers

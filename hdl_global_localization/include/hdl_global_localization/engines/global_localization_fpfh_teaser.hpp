 ...
 * @ref Yang et al., "TEASER: Fast and Certifiable Point Cloud Registration",
 * T-RO, 2020
...
class GlobalLocalizationEngineFPFH_Teaser
    : public GlobalLocalizationEngineFPFH_RANSAC {
  public:

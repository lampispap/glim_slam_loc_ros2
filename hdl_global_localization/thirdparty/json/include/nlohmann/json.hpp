...
#pragma warning(pop)
  ...
  basic_json(std::nullptr_t =
                     nullptr) noexcept  // NOLINT(bugprone-exception-escape)
  ...
  basic_json(initializer_list_t init,
    ...
    bool is_an_object = std::all_of(
            ...
            [](const detail::json_ref<basic_json>& element_ref) {
              ...
              // op[key_type], the wrong semantics, and a 4804 warning on
              // Windows)
    ...
    if (is_an_object) {
      ...
      for (auto& element_ref : init) {
        ...
        m_data.m_value.object->emplace(
                std::move(*((*element.m_data.m_value.array)[0]
  ...
  */
  template <
          ...
          detail::enable_if_t<std::is_same<BasicJsonType, basic_json_t>::value,
                              int> = 0>
  ...
  */
  template <typename ValueType,
        ...
        (defined(__GNUC__) ||   \
         (defined(_MSC_VER) && _MSC_VER >= 1910 && _MSC_VER <= 1914))
                            detail::negation<
                                    std::is_same<ValueType, std::string_view>>,
#endif
  ...
  template <class KeyType,
            detail::enable_if_t<
                    detail::is_usable_as_basic_json_key_type<basic_json_t,
                                                             KeyType>::value,
                    int> = 0>
  ...
  template <
          ...
          detail::enable_if_t<
                  !detail::is_transparent<object_comparator_t>::value &&
                          ...
                          !std::is_same<value_t,
                                        detail::uncvref_t<ValueType>>::value,
                  int> = 0>
  ...
  JSON_HEDLEY_DEPRECATED_FOR(
          ...
          basic_json::json_pointer or
                  nlohmann::json_pointer<
                          basic_json::
                                  string_t>)  // NOLINT(readability/alt_tokens)
  ...
  private:
  template <typename KeyType,
            detail::enable_if_t<detail::has_erase_with_key_type<basic_json_t,
                                                                KeyType>::value,
                                int> = 0>
  ...
  iterator insert(const_iterator pos,
                  initializer_list_t
                          ilist)  // NOLINT(performance-unnecessary-value-param)
  {
    // insert only works for arrays
    if (JSON_HEDLEY_UNLIKELY(!is_array())) {
      JSON_THROW(type_error::create(
...
#pragma GCC diagnostic pop
  ...
  requires std::is_scalar_v<ScalarType> bool operator==(
...
template <>
struct less<::nlohmann::detail::
                    value_t>  // do not remove the space after '<', see

...
IntensityKdTree::IntensityKdTree(const Eigen::Vector4d* points,
    ...
    : num_points(num_points),
      ...
      search_eps(-1.0),
      index(new Index(
              4, *this, nanoflann::KDTreeSingleIndexAdaptorParams(10))) {
  index->buildIndex();
}

IntensityKdTree::~IntensityKdTree() {}

size_t IntensityKdTree::knn_search(const double* pt,
                                   size_t k,
                                   size_t* k_indices,
                                   double* k_sq_dists,

...
gtsam::VectorValues DenseGaussianFactorGraphSolver::solve(
...
gtsam::VectorValues SparseGaussianFactorGraphSolver::solve(
        const gtsam::GaussianFactorGraph& gfg,
        const gtsam::Ordering& ordering) {
...
gtsam::VectorValues GTSAMGaussianFactorGraphSolver::solve(
        const gtsam::GaussianFactorGraph& gfg,
        const gtsam::Ordering& ordering) {

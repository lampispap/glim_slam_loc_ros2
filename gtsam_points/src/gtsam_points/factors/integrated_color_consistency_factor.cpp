...
template class gtsam_points::IntegratedColorConsistencyFactor_<
        gtsam_points::iVox,
        gtsam_points::PointCloud,
        gtsam_points::IntensityGradients>;
template class gtsam_points::IntegratedColorConsistencyFactor_<
        gtsam_points::PointCloud,
        gtsam_points::PointCloud,
        gtsam_points::IntensityGradients>;
// template class
// gtsam_points::IntegratedColorConsistencyFactor_<gtsam_points::IntensityGradientsiVox,
// gtsam_points::PointCloud, gtsam_points::IntensityGradientsiVox>;

...
IntegratedColorConsistencyFactor_<TargetFrame,
                                  SourceFrame,
                                  IntensityGradients>::
...
IntegratedColorConsistencyFactor_<
        TargetFrame,
        SourceFrame,
        IntensityGradients>::~IntegratedColorConsistencyFactor_() {}

template <typename TargetFrame,
          typename SourceFrame,
          typename IntensityGradients>
void IntegratedColorConsistencyFactor_<TargetFrame,
                                       SourceFrame,
                                       IntensityGradients>::
...
template <typename TargetFrame,
          typename SourceFrame,
          typename IntensityGradients>
double IntegratedColorConsistencyFactor_<TargetFrame,
                                         SourceFrame,
                                         IntensityGradients>::
...
#pragma omp parallel for num_threads(num_threads) \
        reduction(+ : sum_errors_photo) schedule(guided, 8)
  for (int i = 0; i < frame::size(*source); i++) {

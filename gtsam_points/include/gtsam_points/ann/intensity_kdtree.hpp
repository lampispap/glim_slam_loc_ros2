 ...
 *        This class concatenates point coordinates (x, y, z) and intensity (i)
 * and finds nearest neighbors on the XYZI space.
 */
struct IntensityKdTree : public NearestNeighborSearch {
  public:
  using Index = nanoflann::KDTreeSingleIndexAdaptor<
          nanoflann::L2_Simple_Adaptor<double, IntensityKdTree, double>,
          IntensityKdTree,
          4,
          size_t>;
   ...
   * @param intensity_scale Scaling parameter to balance Euclidean coordinates
   * and intensities
   */
  IntensityKdTree(const Eigen::Vector4d* points,
